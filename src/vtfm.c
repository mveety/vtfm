...
**		  correspondent utility in VTfm command line).
**
**	2022, February - mveety's hacks
**
**		- Control-Z will attach your terminal to the
**		  parent process (similar to EVE).
*/
	...
	do
	{
		...
		switch (key_pr)
		{
			...
			case	SMG$K_TRM_CTRLW:
					rotate_dir_w(1);
					break;
			case 	SMG$K_TRM_CTRLZ:	// mveety's addition
					ppid = getppid();
					if(ppid != 0){
						// reset the display
